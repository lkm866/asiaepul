...
progress_data = {
    "CNN" : [
        {"title" : "1 weeks ago", "value" : 22.8},
        {"title" : "2 weeks ago", "value" : 58.23},
        {"title" : "3 weeks ago", "value" : 72.1},
        {"title" : "4 weeks ago", "value" : 49.82},
    ],
    "RNN" : [
        {"title" : "1 weeks ago", "value" : 66.8},
        {"title" : "2 weeks ago", "value" : 80.25},
        {"title" : "3 weeks ago", "value" : 72.15},
        {"title" : "4 weeks ago", "value" : 91.82},
    ],
    "LSTM" : [
        {"title" : "1 weeks ago", "value" : 42.1},
        {"title" : "2 weeks ago", "value" : 78.3},
        {"title" : "3 weeks ago", "value" : 90.15},
        {"title" : "4 weeks ago", "value" : 88.88},
    ]
}

@app.get("/progress-data/{model_name}", response_model=List[ProgressData])
def get_progress_data(model_name: str):
    if model_name in progress_data:
        return progress_data[model_name]
    else:
...
@app.get("/prediction-2", response_model=PredictData)
