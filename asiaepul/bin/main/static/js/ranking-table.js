window.addEventListener("load", function (){
	...
	const salesDropdownIcon = salesDropButton.querySelector(".icon-dropdown");
	const rapidDropdownIcon = rapidDropButton.querySelector(".icon-dropdown");
    ...
    salesDropButton.addEventListener("click", async () => {
	    if (salesDropdownOptions.classList.contains("d:none")) {
	        ...
	        salesDropdownIcon.classList.add("rotate-180");
	    } else {
	        ...
	        salesSelectedValues.forEach((salesSelectedValue) => {
            	...
            	salesDropdownIcon.classList.remove("rotate-180");
	        });
	    }
    ...
    rapidDropButton.addEventListener("click", async () => {
	    if (rapidDropdownOptions.classList.contains("d:none")) {
	        ...
	        rapidDropdownIcon.classList.add("rotate-180");
	    } else {
	        ...
	        rapidSelectedValues.forEach((rapidSelectedValue) => {
            	...
            	rapidDropdownIcon.classList.remove("rotate-180");
	        });
	    }
